...
from app.api.public.assemblygroup.models import AssemblyGroup
...
def create_AssemblyGroups():
    ...
    AssemblyGroup_4 = AssemblyGroup(name="Fahrradbremsen")
    AssemblyGroup_5 = AssemblyGroup(name="Fahrradgabeln")
    AssemblyGroup_6 = AssemblyGroup(name="Fahrradrahmen")
    AssemblyGroup_7 = AssemblyGroup(name="Fahrradreifen")
    AssemblyGroup_8 = AssemblyGroup(name="Fahrradschläuche")
