<template>
  <div class="card-header d-flex justify-content-between bg-body-secondary">
    ...
    <div>
      ...
      <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="collapse" :data-bs-target="'#' + assemblygroup.id"
        :aria-label="$t('message.expand')"><i class="bi bi-chevron-expand"></i></button>
    </div>
  </div>
</template>
